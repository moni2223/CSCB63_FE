      ...
      <div className="flex flex-col items-center h-5/6 w-1/3 bg-white rounded-md">
        ...
        <div className="flex flex-col justify-between items-center h-1/2 w-full">
          <div className="w-full flex flex-col items-center justify-center">
            <Inputs.TextInput label={"Потребителско име"} autoComplete="new-password" outerClassName={`w-5/6 mt-4`} number {...register(`userName`, { shouldValidate: true })} />
            <Inputs.TextInput label={"Парола"} autoComplete="new-password" type={!checkPassword && "password"} suffix={<div className="icon see-password w-6 h-6 mr-3" onClick={() => setCheckPassword(!checkPassword)} />} outerClassName={`w-5/6 my-4`} number {...register(`password`, { shouldValidate: true })} />
          </div>
